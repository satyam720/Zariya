...
const CourseView = () => {
   ...
   const handleUnpublish =async  (e, courseId) =>{
    try {
        let answer = window.confirm('Once you Unpublish, It will not be available for users to enroll');
    if (!answer) return;
                ...
                <div className="d-flex">
                    ...
                    <div className="pl-2 d-flex course-edit">
                        <div className="row">
                            ...
                            <Tooltip className="ms-4 " title="Min 5 lessons required to publish">
                                <QuestionOutlined className="h5 pointer text-danger"/>
                            </Tooltip> : course.published ? 
                            <Tooltip className="ms-4 " title="Unpublish">
                                <CloseOutlined 
                                    onClick={e => handleUnpublish(e, course._id)}
                                  className="h5 pointer text-danger"/>
                            </Tooltip>:
                            <Tooltip className="ms-4 " title="Publish">
                                <CheckOutlined  
